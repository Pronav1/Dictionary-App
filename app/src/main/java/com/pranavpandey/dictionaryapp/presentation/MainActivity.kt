...
import com.pranavpandey.dictionaryapp.ui.theme.DictionaryAppTheme
                  ...
                  topBar = {
                      OutlinedTextField(modifier = Modifier
                        ...
                        value = mainState.searchWord,
                          ...
                          label = {
                              Text(text = stringResource(R.string.search_a_word),
                                  fontSize = 15.sp,
...
LazyColumn (
    ...
    items(wordItem.meaning.size){index ->
        Meaning(
            meaning = wordItem.meaning[index],
            index = index
        ...
        Column(
            ...
            if (meaning.definition.definition.isNotEmpty()) {
                ...
                Row(
                    ...
                    Text(
                        text = stringResource(R.string.defination),
                        fontWeight = FontWeight.SemiBold,
                        fontSize = 19.sp,
                        color = MaterialTheme.colorScheme.primary
                    )
